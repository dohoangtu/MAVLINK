...
static void mavlink_test_mav_gmotor_test_pc2mcu(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_mav_gmotor_test_pc2mcu_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mav_gmotor_test_pc2mcu_pack(system_id, component_id, &msg , packet1.motor_id , packet1.motor_dir , packet1.motor_power , packet1.motor_speed );
	mavlink_msg_mav_gmotor_test_pc2mcu_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mav_gmotor_test_pc2mcu_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.motor_id , packet1.motor_dir , packet1.motor_power , packet1.motor_speed );
	mavlink_msg_mav_gmotor_test_pc2mcu_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_mav_gmotor_test_pc2mcu_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mav_gmotor_test_pc2mcu_send(MAVLINK_COMM_1 , packet1.motor_id , packet1.motor_dir , packet1.motor_power , packet1.motor_speed );
	mavlink_msg_mav_gmotor_test_pc2mcu_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_mav_gmotor_test_mcu2pc(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_mav_gmotor_test_mcu2pc_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mav_gmotor_test_mcu2pc_pack(system_id, component_id, &msg , packet1.motor_id , packet1.motor_status , packet1.motor_temp );
	mavlink_msg_mav_gmotor_test_mcu2pc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mav_gmotor_test_mcu2pc_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.motor_id , packet1.motor_status , packet1.motor_temp );
	mavlink_msg_mav_gmotor_test_mcu2pc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_mav_gmotor_test_mcu2pc_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mav_gmotor_test_mcu2pc_send(MAVLINK_COMM_1 , packet1.motor_id , packet1.motor_status , packet1.motor_temp );
	mavlink_msg_mav_gmotor_test_mcu2pc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
