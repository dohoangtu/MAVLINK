...
#define MAVLINK_MSG_ID_MAV_GMOTOR_TEST_PC2MCU_LEN 8
...
#define MAVLINK_MESSAGE_INFO_MAV_GMOTOR_TEST_PC2MCU { \
	...
	{  { "motor_speed", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_mav_gmotor_test_pc2mcu_t, motor_speed) }, \
         ...
         { "motor_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_mav_gmotor_test_pc2mcu_t, motor_id) }, \
         { "motor_dir", NULL, MAVLINK_TYPE_UINT8_T, 0, 7, offsetof(mavlink_mav_gmotor_test_pc2mcu_t, motor_dir) }, \
         } \
}
...
static inline uint16_t mavlink_msg_mav_gmotor_test_pc2mcu_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t motor_id, uint8_t motor_dir, uint16_t motor_power, float motor_speed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[8];
	_mav_put_float(buf, 0, motor_speed);
	_mav_put_uint16_t(buf, 4, motor_power);
	_mav_put_uint8_t(buf, 6, motor_id);
	_mav_put_uint8_t(buf, 7, motor_dir);
	...
	return mavlink_finalize_message(msg, system_id, component_id, 8, 188);
}
						           ...
						           uint8_t motor_id,uint8_t motor_dir,uint16_t motor_power,float motor_speed)
{
	...
	msg->msgid = MAVLINK_MSG_ID_MAV_GMOTOR_TEST_PC2MCU;
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 8, 188);
}
...
{
	return mavlink_msg_mav_gmotor_test_pc2mcu_pack(system_id, component_id, msg, mav_gmotor_test_pc2mcu->motor_id, mav_gmotor_test_pc2mcu->motor_dir, mav_gmotor_test_pc2mcu->motor_power, mav_gmotor_test_pc2mcu->motor_speed);
}
...
static inline void mavlink_msg_mav_gmotor_test_pc2mcu_send(mavlink_channel_t chan, uint8_t motor_id, uint8_t motor_dir, uint16_t motor_power, float motor_speed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[8];
	_mav_put_float(buf, 0, motor_speed);
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAV_GMOTOR_TEST_PC2MCU, buf, 8, 188);
#else
	mavlink_mav_gmotor_test_pc2mcu_t packet;
	packet.motor_speed = motor_speed;
	packet.motor_power = motor_power;
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAV_GMOTOR_TEST_PC2MCU, (const char *)&packet, 8, 188);
#endif
}
...
/**
 * @brief Get field motor_id from mav_gmotor_test_pc2mcu message
 *
 * @return  dia chi dong co 
 */
static inline uint8_t mavlink_msg_mav_gmotor_test_pc2mcu_get_motor_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mav_gmotor_test_pc2mcu_decode(const mavlink_message_t* msg, mavlink_mav_gmotor_test_pc2mcu_t* mav_gmotor_test_pc2mcu)
{
	...
	mav_gmotor_test_pc2mcu->motor_id = mavlink_msg_mav_gmotor_test_pc2mcu_get_motor_id(msg);
	mav_gmotor_test_pc2mcu->motor_dir = mavlink_msg_mav_gmotor_test_pc2mcu_get_motor_dir(msg);
#else
	memcpy(mav_gmotor_test_pc2mcu, _MAV_PAYLOAD(msg), 8);
#endif
}
